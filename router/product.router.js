...
const { Product, ProductPost, Profile, UserData, user ,UserProfile, ProductShow, productGet, adminProduct, singlePaeg, SingleData } = require("../controller/product.controller")
